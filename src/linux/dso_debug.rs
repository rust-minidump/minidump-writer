...
impl MainExecutable {
    ...
    fn compute_bias(
        ...
        Ok(program_header_table_address
            - usize::try_from(table.p_vaddr)
                .expect("Pointer size mismatch between dumper and target"))
    }
...
impl LinkMapIter<'_> {
    fn terminate_iteration(&mut self) {
        self.address = 0
    }
